...
*************************************************************/
	...
	// SSL websites.
	$start_url = "http://printedcart.com/printedcart/";       
	...
	$skip = array (
					"http://printedcart.com/printedcart/public/",
				  );
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible; Printed cart XML Sitemap Generator/" . VERSION . ", http://printedcart.com/printedcart/)";
	...
	echo "<script>window.location.href='http://printedcart.com/printedcart/sitemap'</script>";
	//header("Location:http://printedcart.com/printedcart/sitemap");
	//echo "Done." . NL;
