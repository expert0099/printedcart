...
class BannersController extends Controller
{
	...
	public $view_col = 'banner name';
	public $listing_cols = ['id', 'size_group_id', 'photo_book_way', 'calendar_category_id', 'banner_image', 'isActive'];
	...
	public function dtajax()
	{
		...
		foreach($data->data as $k => $v){
			$img = '';
			$upload = DB::table('uploads')->select('path','hash')->where('id',$v[4])->first();
