...
class BackupsController extends Controller
{
	...
	public $backup_filepath = "/storage/app/http---localhost-printed-carts-/";
	...
	public function downloadBackup($id) {
		...
		if(Module::hasAccess($module->id)) {
			$backup = Backup::find($id);
			$fileFullName = explode('...',$backup->file_name);
			//echo '<pre>';print_r(end($fileFullName));exit;
		
			$path = str_replace("/storage", "", $this->backup_filepath . trim(end($fileFullName)));
