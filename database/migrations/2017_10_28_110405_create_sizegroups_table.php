...
class CreateSizegroupsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Sizegroups", 'sizegroups', 'sizegroup', 'fa-cube', [
            ["sizegroup", "SizeGroup", "TextField", true, "", 3, 20, true],
            ["photo", "Image", "File", false, "0", 0, 0, false],
    ...
    {
        if (Schema::hasTable('sizegroups')) {
            Schema::drop('sizegroups');
        }
    }
}
