...
@section("contentheader_title", "CalendarDefaultPages")
@section("contentheader_description", "CalendarDefaultPages listing")
@section("section", "CalendarDefaultPages")
@section("sub_section", "Listing")
@section("htmlheader_title", "CalendarDefaultPages Listing")

@section("headerElems")
@la_access("CalendarDefaultPages", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add CalendarDefaultPage</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add CalendarDefaultPage</h4>
			</div>
			{!! Form::open(['action' => 'LA\CalendarDefaultPagesController@store', 'id' => 'calendardefaultpage-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/calendardefaultpage_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#calendardefaultpage-add-form").validate({
