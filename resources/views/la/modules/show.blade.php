...
<link rel="stylesheet" type="text/css" href="{{ asset('public/la-assets/plugins/bootstrap-slider/slider.css') }}"/>
<style>
...
<script src="{{ asset('public/la-assets/plugins/bootstrap-slider/bootstrap-slider.js') }}"></script>
<script src="{{ asset('public/la-assets/plugins/jQueryUI/jquery-ui.js') }}"></script>
