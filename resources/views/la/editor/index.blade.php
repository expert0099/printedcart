...
@push('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('public/la-assets/plugins/jquery-filetree/jQueryFileTree.min.css') }}"/>
@endpush

@push('scripts')
<script src="{{ asset('public/la-assets/plugins/jquery-filetree/jQueryFileTree.min.js') }}"></script>
<script src="{{ asset('public/la-assets/plugins/ace/ace.js') }}" type="text/javascript" charset="utf-8"></script>
<script src="{{ asset('public/la-assets/plugins/ace/ext-modelist.js') }}" type="text/javascript" charset="utf-8"></script>
