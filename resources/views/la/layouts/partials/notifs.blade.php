							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="@if(isset(Auth::user()->email)) {{ URL::asset('public/la-assets/img/user2-160x160.jpg') }} @else {{ URL::asset('public/la-assets/img/user2-160x160.jpg') }} @endif" class="img-circle" alt="User Image"/>
										</div>
				...
				@else
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{URL::asset('public/la-assets/img/user2-160x160.jpg') }}" class="user-image" alt="User Image"/>
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="{{ URL::asset('public/la-assets/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image" />
								<p>
									{{ Auth::user()->name }}
									<?php
							...
							<li class="user-footer">
								...
								<div class="pull-right">
									<a href="{{ url(config('laraadmin.adminRoute') . '/logout') }}" class="btn btn-default btn-flat">Sign out</a>
								</div>
							</li>
						</ul>
					</li>
