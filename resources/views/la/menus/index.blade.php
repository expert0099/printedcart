...
@push('scripts')
<script src="{{ asset('public/la-assets/plugins/nestable/jquery.nestable.js') }}"></script>
<script src="{{ asset('public/la-assets/plugins/iconpicker/fontawesome-iconpicker.js') }}"></script>
<script>
$(function () {
