...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $shippingprice->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ShippingPrices", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/shippingprices/'.$shippingprice->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ShippingPrices", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.shippingprices.destroy', $shippingprice->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/shippingprices') }}" data-toggle="tooltip" data-placement="right" title="Back to ShippingPrices"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'shipping_category_id')
						@la_display($module, 'size_group_id')
						@la_display($module, 'qty_min')
						@la_display($module, 'qty_max')
						@la_display($module, 'price')
						@la_display($module, 'inc_price')
						@la_display($module, 'size_id')
					</div>
				</div>
			</div>
		</div>
