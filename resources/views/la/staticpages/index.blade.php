...
@section("contentheader_title", "StaticPages")
@section("contentheader_description", "StaticPages listing")
@section("section", "StaticPages")
@section("sub_section", "Listing")
@section("htmlheader_title", "StaticPages Listing")

@section("headerElems")
@la_access("StaticPages", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add StaticPage</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add StaticPage</h4>
			</div>
			{!! Form::open(['action' => 'LA\StaticPagesController@store', 'id' => 'staticpage-add-form']) !!}
