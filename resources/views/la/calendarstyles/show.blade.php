...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $calendarstyle->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("CalendarStyles", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/calendarstyles/'.$calendarstyle->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("CalendarStyles", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.calendarstyles.destroy', $calendarstyle->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/calendarstyles') }}" data-toggle="tooltip" data-placement="right" title="Back to CalendarStyles"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'calendar_style')
						@la_display($module, 'calendar_category_id')
						@la_display($module, 'calendar_style_type_id')
						@la_display($module, 'photo')
						@la_display($module, 'standard')
						@la_display($module, 'storytelling')
						@la_display($module, 'art_library')
						@la_display($module, 'of_photos')
						@la_display($module, 'reg_corner')
						@la_display($module, 'round_corner')
						@la_display($module, 'float_paperie')
						@la_display($module, 'paper_plains')
						@la_display($module, 'potts_design')
						@la_display($module, 'yours_truly')
						@la_display($module, 'disney')
						@la_display($module, 'printedcart')
						@la_display($module, 'design_style')
						@la_display($module, 'design_size')
