...
@section("contentheader_title", "CollegePosterLayouts")
@section("contentheader_description", "CollegePosterLayouts listing")
@section("section", "CollegePosterLayouts")
@section("sub_section", "Listing")
@section("htmlheader_title", "CollegePosterLayouts Listing")

@section("headerElems")
@la_access("CollegePosterLayouts", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add CollegePosterLayout</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add CollegePosterLayout</h4>
			</div>
			{!! Form::open(['action' => 'LA\CollegePosterLayoutsController@store', 'id' => 'collegeposterlayout-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/collegeposterlayout_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#collegeposterlayout-add-form").validate({
