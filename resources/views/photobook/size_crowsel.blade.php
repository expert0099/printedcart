<h1 class="d-block text-center py-5">Choose your photo book size to get started in Custom Path</h1>
...
<div class="see-price-details">
	<div class="col-12 text-center mt-4">
		<a class="btn btn-primary border-0 rounded-0 px-4 text-white" href="{{URL::asset('photobooks/cover_pricing_detail')}}">See cover and pricing details</a>
	</div>
</div>