                ...
                <div class="bhoechie-tab-content">
                    <div class="second-tab-sec">
						...
						@foreach($background as $k => $v)
							<img class='img-fluid' src="{{ URL::asset($v['background_image_path']) }}" alt='background' style='width:23%;'>
						@endforeach
...
$(document).ready(function() {
	...
	$('.img-fluid').click(function(){
		...
		if(alt == 'layout'){
			...
			$("#image-gallery li.active #layoutbox").html(page_content);
