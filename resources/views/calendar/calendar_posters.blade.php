	...
	<div class="row pt-2 pt-md-5 page-top-gapping">
						...
						<div id="exampleAccordion" data-children=".item">
							<div class="item poster-size-box mb-3 pb-2">
								...
								<div id="exampleAccordion1" class="collapse show" role="tabpanel">
									<div class="row">
										@foreach($col_pos_size as $k => $v)
										<div class="col-4 size-one text-center mb-2">
											<label class="custom-control custom-checkbox m-0">
												<input type="checkbox" class="custom-control-input" name="design_size" rel="{!! $v['Size']['Size'] !!}">
												<span class="custom-control-indicator"></span>
											</label>
											<span class="custom-control-description fz-14 d-block mt-2">{!! $v['Size']['Size'] !!}</span>
										</div>
										@endforeach
									</div>
								</div>
							...
							<!--<div class="item mb-3 pb-2">
								<a data-toggle="collapse" data-parent="#exampleAccordion" href="#exampleAccordion4" aria-expanded="false" aria-controls="exampleAccordion1">Design color</a>
								<div id="exampleAccordion4" class="collapse show choose-color-sidebar" role="tabpanel">
									<div class="row pb-3">
										<div class="col-auto pr-0 white-desgin">
											<label class="custom-control custom-radio m-0">
											<input id="radioStacked3" name="radio-stacked" type="radio" class="custom-control-input">
											<span class="custom-control-indicator"></span>
											</label>
										</div>
										<div class="col-auto pr-0 design-gradient-one">
											<label class="custom-control custom-radio m-0">
											<input id="radioStacked4" name="radio-stacked" type="radio" class="custom-control-input">
											<span class="custom-control-indicator"></span>
											</label>
										</div>
										<div class="col-auto design-gradient-two">
											<label class="custom-control custom-radio m-0">
											<input id="radioStacked4" name="radio-stacked" type="radio" class="custom-control-input">
											<span class="custom-control-indicator"></span>
											</label>
		...
		<div class="col-md-7 col-lg-8 col-xl-9">
			...
			<div class="calendar-liting-section mt-4 mt-md-0">
				<h4 class="fz-26">Calendar Posters</h4>
...
$(function(){
	...
	$(document).on('click', '.pagination a',function(event){
		...
		var page=$(this).attr('href').split('calendar_posters')[1];
		getData(page);
    });
