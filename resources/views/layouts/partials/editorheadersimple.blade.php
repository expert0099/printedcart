	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav align-items-center">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" id="save_project_popup" href="javascript:void(0)">Save</a>
			...
			<ul class="navbar-nav ml-auto align-items-center">
				<!--<li class="nav-item"><a class="nav-link" id="pdf" href="" target="_blank">PDF</a></li>-->
				<li class="nav-item"><a class="nav-link" id="save_pages" href="javascript:void(0)">Save</a></li>
				<li class="nav-item"><a class="nav-link" id="preview" href="javascript:void(0)">Preview</a></li>
