	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav align-items-center">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<!--<a class="dropdown-item" href="{{ URL::asset('photobooks/custom_path/project/'.$project_id) }}">Current Project</a>
			...
			<ul class="navbar-nav align-items-center editor-icons">
				...
				<li class="nav-item">
					<a class="nav-link" id="btnPopover" href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-picture-o" aria-hidden="true"></i> Add photos</a>
				</li>
				<!--<li class="nav-item">
			...
			<ul class="navbar-nav ml-auto align-items-center">
				<!--<li class="nav-item"><a class="nav-link" id="pdf" href="{{ URL::asset('photobooks/htmltopdfview/'.$project_id.'/show') }}" target="_blank">PDF</a></li>-->
				
				<li class="nav-item"><a class="nav-link" id="save_pages" href="javascript:void(0)">Save</a></li>
				
				<li class="nav-item"><a class="nav-link" id="preview" href="#">Preview</a></li>
