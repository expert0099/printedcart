	...
	<div class="container">
		...
		<div class="collapse navbar-collapse d-lg-block" id="navbarSupportedContent">
			<ul class="navbar-nav mr-lg-auto float-md-right align-items-md-center">
				...
				<!--<li class="nav-item">
					<a class="nav-link" id="basket" href="#">
						<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						<span id="cart_count" class="label label-success">@if(null!==$item_count){{$item_count}}@else 0 @endif</span>
					</a>
				</li>-->
				@if(\Auth::check())
				<li class="nav-item">
			...
			<ul class="navbar-nav align-items-center">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<!--<a class="dropdown-item" id="save_project" style="cursor:pointer;">Save</a>
